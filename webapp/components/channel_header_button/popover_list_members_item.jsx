...
export default class PopoverListMembersItem extends React.PureComponent {
	...
	render() {
		...
		return (
			<div onMouseEnter={this.rowStartShowHover} onMouseLeave={this.rowStartHideHover} onClick={this.handleClick}
			...
			>
				<span
					...
					dangerouslySetInnerHTML={
						this.props.cam == 1 ? { __html: Svgs.BBBCAM} : {__html: Svgs.VID_CAM_PLAY}}
					aria-hidden="true"
				/>
